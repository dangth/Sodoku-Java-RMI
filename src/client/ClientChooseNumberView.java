...
public class ClientChooseNumberView extends JFrame {
    ...
    public ClientChooseNumberView(Cell cell) {
        super("Choose Number Cell " + cell.getToaDoX() + ":" + cell.getToaDoY());
        this.cell = cell;
        txtNumber = new JLabel("Number" + cell.getToaDoX() + ":" + cell.getToaDoY());
        ...
        for (int i = 0; i < 9; i++) {
            ...
            button[i].setFont(new Font("Serif", Font.BOLD | Font.ITALIC, 18));
